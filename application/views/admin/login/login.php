...
<head>
	...
	<!-- Font Awesome -->
	<link rel="stylesheet" href="<?=admin_assets()?>dist/css/font-awesome.css">
	<!-- Ionicons -->
	<link rel="stylesheet" href="<?=admin_assets()?>plugins/ionicons-2.0.1/css/ionicons.min.css">
	<!-- Theme style -->
		...
		<div class="login-box-body">
			...
			<div class="social-auth-links text-center">
				...
				<?=($this->session->flashdata('sukses'))?
					'<div class="alert alert-success fade in text-center">'.$this->session->flashdata('sukses').'</div>' : ''?>
				<?=($this->session->flashdata('gagal'))?
					'<div class="alert alert-danger fade in text-center">'.$this->session->flashdata('gagal').'</div>' : ''?>

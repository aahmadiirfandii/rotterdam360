...
<div id="wrapDetailInformasi">
    <button type="button" id="btnInformasi" class="btn btn-primary">Deskripsi <i class="fa fa-chevron-up ml-2"></i> <buton>
...
<div id="infoBox" class="overflow-auto" style="display: none">
    ...
    <p class="text-center" id="detail-btn-container" style="display: none;">
        <a id="detailButton" href="#" class="btn btn-sm rounded-pill btn-danger btn-lihat-detail">Lihat Detail Lengkap <i class="fa fa-arrow-right ml-2"></i> </a>
    </p>
</div>
<div id="logo-wrap">
